...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1144, 602)
        MainWindow.setMaximumSize(QtCore.QSize(1300, 615))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 810, 600))
        ...
        self.plainTextEdit_9.setGeometry(QtCore.QRect(0, 0, 810, 590))
        ...
        self.plainTextEdit_10.setGeometry(QtCore.QRect(0, 0, 810, 590))
        ...
        self.plainTextEdit_11.setGeometry(QtCore.QRect(0, 0, 810, 590))
        self.plainTextEdit_11.setObjectName("plainTextEdit_11")
        self.tabWidget.addTab(self.tab_11, "")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(855, 110, 44, 34))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(855, 156, 43, 34))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.label_5.setGeometry(QtCore.QRect(840, 20, 271, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.label_6.setGeometry(QtCore.QRect(820, 575, 361, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.label_4.setGeometry(QtCore.QRect(914, 156, 231, 34))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.label_3.setGeometry(QtCore.QRect(934, 110, 231, 34))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.label_7.setGeometry(QtCore.QRect(912, 556, 231, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.line.setGeometry(QtCore.QRect(830, 50, 291, 20))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setGeometry(QtCore.QRect(854, 140, 241, 16))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.line_3 = QtWidgets.QFrame(self.centralwidget)
        self.line_3.setGeometry(QtCore.QRect(854, 190, 241, 16))
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(890, 470, 171, 61))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.calendarWidget.setGeometry(QtCore.QRect(850, 240, 248, 197))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.plainTextEdit_7.setPlainText(_translate("MainWindow", info.get_dns_info()))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _translate("MainWindow", "DNS Info"))
        self.plainTextEdit_8.setPlainText(_translate("MainWindow", info.get_disk_info()))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("MainWindow", "Disk Info"))
        self.plainTextEdit_9.setPlainText(_translate("MainWindow", info.get_file_handle()))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_9), _translate("MainWindow", "Handle"))
        self.plainTextEdit_10.setPlainText(_translate("MainWindow", info.get_process_info()))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_10), _translate("MainWindow", "Process"))
        self.plainTextEdit_11.setPlainText(_translate("MainWindow", info.get_service_info()))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_11), _translate("MainWindow", "Service"))
